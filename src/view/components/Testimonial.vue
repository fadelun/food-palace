...
<template>
  <section id="testimonial" class="mt-40 lg:mt-24 relative">
    <div class="container mx-auto flex flex-col lg:flex-row">
      <div
        class="testimonial-text lg:w-1/2 flex flex-col lg:flex-row lg:flex-wrap px-20 lg:px-[150px] items-center content-center"
      >
        ...
        <button class="arrow order-4 flex justify-end items-center gap-2">
